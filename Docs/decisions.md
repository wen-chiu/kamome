...
## 2026-09-25 (b) — "No drive path" is asked again on foot: land a car cannot reach is not a crossing
...
5. **Schema v10** clears stored `no_road` to NULL again, as v7 did. Otherwise
