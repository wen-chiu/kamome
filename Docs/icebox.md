...
- **Partly superseded, 2026-08-15:** `Docs/cross-region-journeys.md` took this
  question further — a crossing is a *beat*, not a bounding box — and is the
  current thinking. This entry stays for the airport framing and the schema note,
  which that document does not cover.
