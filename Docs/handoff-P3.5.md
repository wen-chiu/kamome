...
## 1. Stand up OSRM and validate matching end-to-end (next session, ~half a session)
...
## 4. Then: the combined device day (needs Chiu + iPhone)

One drive covers P3 items (2 h drive, region-resume item C, limited-photo
re-check, < 90 s budget via S5 readout, S5 UX pass) and the P3.5 budget
re-proof on the MapLibre substrate. Only after that: P3 closes, P3.5 gate
judged (including "Chiu posts one recap somewhere real"), demo artifact in
`Docs/demos/phase3_5/`.
