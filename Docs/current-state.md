...
Last synced: 2026-09-12 against decisions.md **2026-09-12 (b)** and `main` at
**PR #54**. Config flip made (S6 closed, S7 new — rotation owed); the local-network
permission is Debug-only (ADR 2026-09-12 (b)). Film persists
