...
**ADR 2026-09-24 (c)**: deleting a trip stops its export first; Home's swipe
asks; the side-load is a switch (`KAMOME_SIDELOAD_REGIONS`), off in Release.
Open P1s: `Docs/handoff-arch-review-2026-09-24.md`.
