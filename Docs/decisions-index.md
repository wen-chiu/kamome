...
| 67 | `2026-09-05 (d)` | The end card is the map again: a slight dim, and the summary floating on it | **supersedes 2026-09-05 (c) §4(a) and §4(c); `endChrome` and `RecapTrip.statsLines` change shape** |
...
| 69 | `2026-09-09` | The export substrate leaves Apple Maps: OpenFreeMap + MapLibre, and this round only looks at it | **Chiu 2026-09-09.** Reopens the **2026-08-15** MapLibre park for the export path; opens the **2026-08-15 label lock for evaluation only**, without unlocking it; the §0 shipping question is **deferred**, not answered |
