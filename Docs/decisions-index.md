...
| 64 | `2026-09-05` | The user is told once, before any coordinate leaves, and the telling is not a question | **answers the question `Docs/release-readiness.md` S3 left open; half-closes S4** |
