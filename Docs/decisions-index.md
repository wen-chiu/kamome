...
| 67 | `2026-09-05 (d)` | The end card is the map again: a slight dim, and the summary floating on it | **supersedes 2026-09-05 (c) §4(a) and §4(c); `endChrome` and `RecapTrip.statsLines` change shape; its three tuned values are registered against the substrate change (2026-09-09)** |
