...
| 61 | `2026-09-04` | The crossing that carries a boarding pass flies a plane, and its two ends are marked | **reclaims `cross-region-journeys.md` requirement 2; answers the closeout's handover item 1** |
